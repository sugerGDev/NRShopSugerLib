...
#define FOREGROUND_STAR_IMAGE_NAME @"CWStarRateView.bundle/star_off"
#define BACKGROUND_STAR_IMAGE_NAME @"CWStarRateView.bundle/star_on"
...
- (void)buildDataAndUI {
    ...
    _allowModifiedStar = NO; // 默认不能修改星星
