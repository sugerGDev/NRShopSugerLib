...
- (BOOL)isInitRes {
    return self.currentPlayerItem != nil;
}
- (void)stop{
    ...
    if ([keyPath isEqualToString:@"status"]) {
        ...
        switch (status) {
            case AVPlayerItemStatusUnknown:{
                [self.pStatusDelegate jpVideoPlayer:self WithPlayerStatus:AVPlayerItemStatusUnknown];
            }
                break;
...
//                [self.player play];
                ...
                [self.pStatusDelegate jpVideoPlayer:self WithPlayerStatus:AVPlayerItemStatusReadyToPlay];
            }
                break;
                
            case AVPlayerItemStatusFailed:{
                [self.pStatusDelegate jpVideoPlayer:self WithPlayerStatus:AVPlayerItemStatusFailed];
            }
                break;
            default:
                break;
