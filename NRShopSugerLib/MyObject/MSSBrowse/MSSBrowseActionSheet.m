...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.titleLabel.frame = CGRectMake(0, 0, self.width, kBrowseActionSheetCellHeight);
    ...
    if(indexPath.section == 0)
    {
        ...
        {
            cell.bottomLineView.frame = CGRectMake(0, kBrowseActionSheetCellHeight - 1, self.width,1);
...
- (void)disMissActionSheet
{
    [UIView animateWithDuration:0.3 animations:^{
        _tableView.centerY = self.height;
...
- (void)showInView:(UIView *)view
{
    ...
    _tableView.frame = CGRectMake(0, self.height, self.width, _tableViewHeight);
    [UIView animateWithDuration:0.3 animations:^{
        _tableView.centerY = self.height - _tableViewHeight;
    }];
}
...
- (void)updateFrame
{
    if(self.superview)
    {
        ...
        _tableView.frame = CGRectMake(0, self.height - _tableViewHeight, self.width, _tableViewHeight);
